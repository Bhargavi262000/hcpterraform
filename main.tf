...
resource "google_compute_network" "network8"{
  name                                        = "network-vpc8"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network9"{
  name                                        = "network-vpc9"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network8iy  qw0"{
  name                                        = "network-vpc80"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network1001"{
  name                                        = "network-vpc1"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network1899"{
  name                                        = "network-vpc19"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network1oiu9"{
  name                                        = "network-vpc19"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network20dc"{
  name                                        = "network-vpc20"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network21u0"{
  name                                        = "network-vpc21"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network22DSPJO"{
  name                                        = "network-vpc22"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network23EGOWP"{
  name                                        = "network-vpc23"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network466"{
  name                                        = "network-vpc46"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network666"{
  name                                        = "network-vpc66"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
...
resource "google_compute_network" "network1111"{
  name                                        = "network-vpc1"
  delete_default_routes_on_create = false
  auto_create_subnetworks           = false
  routing_mode                      = "REGIONAL"
